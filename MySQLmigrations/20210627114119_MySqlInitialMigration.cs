            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AuthorId = table.Column<string>(type: "varchar(255)", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ActivityId = table.Column<Guid>(type: "char(255)", nullable: true, collation: "ascii_general_ci"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AppUserId = table.Column<string>(type: "varchar(255)", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ActivityId = table.Column<Guid>(type: "char(255)", nullable: false, collation: "ascii_general_ci"),
